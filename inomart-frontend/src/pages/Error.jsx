...
export default function Error() {
  ...
  return (
    <>
      <div class="bg-purple-200 w-full px-16 md:px-0 h-screen flex items-center justify-center">
        <div class="bg-white border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
          ...
          <Link
            class="flex items-center space-x-2 bg-gray-600 hover:bg-gray-700 text-gray-100 px-4 py-2 mt-6 rounded transition duration-150 font-serif"
            to={-1}
          >
            <svg
