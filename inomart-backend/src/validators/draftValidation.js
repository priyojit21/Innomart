...
export const draftValidation = z
  .object({
    productName: z
      .string()
      .trim()
        ...
        z.string().superRefine((data, ctx) => {
          try {
            ...
            const schema = z.object({
              regularPrice: z
                .number()
                .min(1, { message: "Regular price must be >= 1." }).optional(),
              sellingPrice: z
                .number()
                .min(1, { message: "Selling price must be >= 1." }).optional(),
              ...
              skuId: z
                .string()
                .trim()
                .min(1, { message: "SKU ID is required." }).optional(),
    ...
    isDraft: z.string().trim().optional(),
  })
  .strict();
